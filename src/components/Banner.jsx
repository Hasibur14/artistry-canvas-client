                ...
                <SwiperSlide>
                    <div className="slide-content" style={slideContentStyle}>
                        ...
                        <div className="text-overlay space-y-5" style={textOverlayStyle}>
                            <h2 className='text-3xl md:text-5xl lg:text-7xl  font-bold animate__animated animate__backInDown'> Elevating Your Artistic Journey - Explore, Create, and Inspire</h2>
